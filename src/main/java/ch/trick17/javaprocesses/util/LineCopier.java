...
/**
 * A simple {@link Runnable}/{@link Callable} that copies all text from a {@link BufferedReader} to
 * a {@link LineWriter}, line by line.
 * 
 * @author Michael Faes
 */
public class LineCopier implements Runnable, Callable<Void> {
     ...
     * {@link InputStreamReader} (with the default charset) and in a {@link BufferedReader}.
     * 
     * @param in
     *            Source
     * @param writer
     *            Destination
     */
    public LineCopier(final InputStream in, final LineWriter... writer) {
