...
/**
 * A class that can be used to start a program with {@link AutoExit} enabled.
 * The name of the main class to start is expected to be provided as the first
...
public class AutoExitProgram {
    ...
    /**
     * This main method {@linkplain AutoExit#install() installs} an
     * {@link AutoExit} instance and then calls the main method of the class
     * given by the first command line argument. The rest of the arguments are
     * passed to that main method.
     * 
     * @param args
